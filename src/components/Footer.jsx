    ...
    <footer className="border-t border-slate-200/80 bg-white w-full max-w-full overflow-hidden">
      <div className="mx-auto max-w-[1520px] px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.75fr_0.85fr_0.7fr]">
          <div>
            <a href={mainUrl} className="inline-block">
              <img
                src={logoSrc}
                alt="ILUMAA"
            ...
            <p className="mt-5 max-w-sm text-sm leading-7 text-slate-600">
              ILUMAA Professional Accelerator Programmes. Building job-ready capabilities through hands-on projects and industry mentorship.
            </p>
          ...
          <div>
            ...
            <div className="mt-5 flex flex-col gap-3">
              ...
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-700 transition hover:bg-blue-600 hover:text-white">
                  <Linkedin size={15} />
                </div>
                LinkedIn
              </a>
              <a
                ...
                className="inline-flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.16em] text-slate-600 transition hover:translate-x-1 hover:text-blue-600"
              >
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-slate-100 text-slate-700 transition hover:bg-pink-600 hover:text-white">
                  <Instagram size={15} />
                </div>
                Instagram
              </a>
